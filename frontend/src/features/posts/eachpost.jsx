...
{   console.log(props)
    return(
           ...
           <div class="post__top"style={{  borderBottom:" 1px solid lightgray"}} >
            <img
            ...
            <div class="post__topInfo">
              ...
              <h3 style={{ marginRight: '200px' }}>{props.post.tittle}</h3>{' '}
                
            <br />
            <p>{props.post.postdisc}</p>
            <img src={props.post.postpic} style={{width:"100%",height:"300px"}}></img>
            <div className="d-flex"   >
            <i
              className="bi bi-hand-thumbs-up-fill ucolor"
              onClick={() => {
                props.inc(props.myindex);
              }}
            >  like</i>
            <span style={{ marginRight: '30px' }}>{props.post.likes}</span>
            
            <i
              className="bi bi-hand-thumbs-down-fill dcolor"
              onClick={() => {
                props.dec(props.myindex);
              }}
            > dislike</i>
            <span style={{ marginRight: '30px' }}>{props.post.dislikes}</span>
            <i
               class="bi bi-chat ccolor"
          ...
          <div className="d-flex mt-3 ">
            ...
            <button
              ...
              onClick={() => {
                props.addcomment(props.myindex);
                props.setflag(0)
              }}
            >
              Add
